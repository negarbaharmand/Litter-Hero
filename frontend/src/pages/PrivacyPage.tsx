    ...
    <PageShell>
      ...
      >
        ...
        <div>
          ...
          <p className="text-base mt-2" style={{ color: 'var(--color-text-body)' }}>
        ...
        <div>
          ...
          <p className="text-base mt-2 mb-3" style={{ color: 'var(--color-text-body)' }}>
          ...
          <div className="card flex flex-col gap-3">
            {[
              ...
              <div key={row.type} className="flex flex-col gap-0.5 pb-3 border-b last:border-b-0 last:pb-0" style={{ borderColor: 'var(--color-border)' }}>
                <span className="font-semibold text-base" style={{ color: 'var(--color-text-primary)' }}>{row.type}</span>
                <span className="text-base" style={{ color: 'var(--color-text-body)' }}>{row.purpose}</span>
        ...
        <div>
          ...
          <ul className="text-base mt-2 flex flex-col gap-2" style={{ color: 'var(--color-text-body)' }}>
