...
export function ReportsPage() {
  ...
  const activeTab =
    searchParams.get("tab") === "vote-queue" ? "vote-queue" : "reports";
    ...
    >
      <div className="mx-auto w-full max-w-4xl px-4 pt-6 text-left">
        ...
        >
            ...
            style={{
              ...
              color:
                activeTab === "reports"
                  ...
                  : "var(--color-text-body)",
              boxShadow:
                activeTab === "reports" ? "0 1px 3px rgba(0,0,0,0.15)" : "none",
            }}
          >
            All reports
          </button>
          <button
            role="tab"
            aria-selected={activeTab === "vote-queue"}
            aria-controls="reports-panel"
        ...
        <section
          id="reports-panel"
          role="tabpanel"
          aria-label={activeTab === "reports" ? "All reports" : "Vote queue"}
          className="rounded-2xl ml-0"
        >
